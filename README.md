### Olá, eu sou o Felipe! 👋
- Eu sou um desenvolvedor front-end iniciante, atualmente estudando no IFPR [ou outra instituição de ensino]. Meus interesses em desenvolvimento front-end incluem a criação de interfaces de usuário atraentes e intuitivas, bem como o uso de tecnologias modernas para tornar as aplicações web mais interativas.

- Embora eu não tenha experiência profissional na área, estou constantemente buscando aprimorar minhas habilidades por meio de cursos online, projetos pessoais e colaborações com outros desenvolvedores. Meu conhecimento atual inclui HTML, CSS e JavaScript, além de familiaridade com frameworks populares como React e Vue.

- Estou empolgado em explorar novas tecnologias e ferramentas, sempre buscando maneiras de melhorar minhas habilidades como desenvolvedor front-end e contribuir para a comunidade de desenvolvimento de software.
### Minhas habilidades

### Como entrar em contato comigo

- me chame no email, instagram ou Discord: 
 <div> 
